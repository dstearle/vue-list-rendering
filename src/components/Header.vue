...
<template>
    ...
    <ul class="nav nav-pills">
        ...
        <router-link to="/listOne" tag="li"><button type="button" class="btn btn-outline-success">List One</button></router-link>
        ...
        <router-link to="/listSeven" tag="li"><button type="button" class="btn btn-outline-success">List Seven</button></router-link>
